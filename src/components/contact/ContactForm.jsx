      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`pl-10 w-full rounded-lg py-3 px-4 border ${
                errors.name ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
              } bg-white dark:bg-gray-800 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-white`}
        ...
        <div>
          <motion.button
            ...
            className={`w-full flex justify-center items-center gap-2 py-3 px-6 rounded-lg font-medium ${
              isSubmitting
