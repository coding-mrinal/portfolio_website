      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="order-2 lg:order-2 space-y-6 mt-8 lg:mt-0"
          >
            {/* Intro Hook */}
            <div className="space-y-4">
              ...
              <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 leading-relaxed">
                By day, I craft clean, functional code and design experiences that feel natural to navigate. My focus is on turning ideas into products that are as intuitive as they are reliable.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 rounded-2xl p-6 border border-indigo-100 dark:border-indigo-900/30"
              >
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-gradient-to-br from-pink-50 to-amber-50 dark:from-pink-900/20 dark:to-amber-900/20 rounded-2xl p-6 border border-pink-100 dark:border-pink-900/30"
              >
            ...
            <motion.p
              ...
              viewport={{ once: true }}
              className="text-base text-gray-600 dark:text-gray-400 italic mt-6 pl-4 border-l-2 border-gray-300 dark:border-gray-600"
            >
